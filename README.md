# 🚀 The Visitor's Journey | AI Destekli Müşteri Analiz Sistemi

Visitor's Journey, e-ticaret siteleri ve dijital platformlar için geliştirilmiş, makine öğrenimi algoritmalarını kullanarak ziyaretçi davranışlarını analiz eden ve satın alma olasılığını tahmin eden modern bir web dashboard uygulamasıdır.
...
* **Frontend:** HTML5, CSS3 (Advanced Animations), Bootstrap 5, JavaScript (ES6+).
* **Backend:** Python / Flask.
* **Kütüphaneler:** AOS (Animate On Scroll), Anime.js, FontAwesome, Swiper.js.
* **Veri Bilimi:** Scikit-learn, XGBoost (Model entegrasyonuna hazır yapı).
